          ...
          <tr>
            <td align="center" style="padding-top: 30px;">
              <p style="color: #5A5A7A; font-size: 12px; margin: 0;">
                © ${new Date().getFullYear()} mdsabbir.dev — Penetration Tester & Full Stack Developer
              </p>
              <div style="margin-top: 12px;">
                ...
                <a href="https://www.linkedin.com/in/md--sabbir-hossain" style="color: #5A5A7A; text-decoration: none; margin: 0 8px; font-size: 12px;">LinkedIn</a>
                <span style="color: #2A2A45;">•</span>
